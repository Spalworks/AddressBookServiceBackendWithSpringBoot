...
public class AddressBookExceptionHandler {
	...
	public ResponseEntity<ResponseDTO> handleMethodArgumentNotValidException(
		...
		ResponseDTO responseDTO = new ResponseDTO(errorMap,"Method parameters invalid while processing Http Method Request");
		return new ResponseEntity<>(responseDTO, HttpStatus.BAD_REQUEST);
	}
	
	@ExceptionHandler(AddressBookException.class)
	public ResponseEntity<ResponseDTO> handleUserDataNotFoundException(AddressBookException exception) {
